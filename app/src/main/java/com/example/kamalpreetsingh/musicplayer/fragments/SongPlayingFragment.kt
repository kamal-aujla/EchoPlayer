...
import com.example.kamalpreetsingh.musicplayer.CurrentSongHelper
import com.example.kamalpreetsingh.musicplayer.R
import com.example.kamalpreetsingh.musicplayer.Songs
import java.util.*
...
class SongPlayingFragment : Fragment() {
    ...
    var updateSongTime= object : Runnable{
        override fun run(){
            ...
            ,TimeUnit.MILLISECONDS.toSeconds(getCurrent?.toLong() as Long)-TimeUnit.MILLISECONDS.toSeconds(TimeUnit.MILLISECONDS.toSeconds(getCurrent?.toLong() as Long)
            )))
